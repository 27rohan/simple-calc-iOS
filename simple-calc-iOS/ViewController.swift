...
class ViewController: UIViewController {
    ...
    func calculate(op1: String, op2: String, operation:String) -> String{
    ...
    @IBAction func pressed_add(_ sender: AnyObject) {
        ...
        */
        if operation != ""{
            ...
            temp = ""
            if toggle == true{
                display.text = calculate(op1: inputs[0], op2: inputs[1], operation: "+")
